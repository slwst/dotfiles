# From the excellent Sioodmy's dotfiles:
# https://github.com/sioodmy/dotfiles/blob/bb2d20b1e7f87da9cc856c32e9e3eee74ed0b5a0/modules/home/rofi/default.nix
# modified for x and i3
{
  config,
  lib,
  pkgs,
